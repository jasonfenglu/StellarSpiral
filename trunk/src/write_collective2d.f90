...
dsetname='density'
call output2d(q_loc(:,:,1),ncell(1),ncell(2),ncell_loc(1),ncell_loc(2),ibuf,jbuf,2,2,flnm,dsetname,0)
dsetname='momx'
...
#ifdef MHD
 dsetname='momz'
 call output2d(q_loc(:,:,4),ncell(1),ncell(2),ncell_loc(1),ncell_loc(2),ibuf,jbuf,2,2,flnm,dsetname,0)
 dsetname='bxl'
 call output2d(q_loc(:,:,5),ncell(1),ncell(2),ncell_loc(1),ncell_loc(2),ibuf,jbuf,2,2,flnm,dsetname,0)
 dsetname='byl'
 call output2d(q_loc(:,:,6),ncell(1),ncell(2),ncell_loc(1),ncell_loc(2),ibuf,jbuf,2,2,flnm,dsetname,0)
 dsetname='bzl'
 call output2d(q_loc(:,:,7),ncell(1),ncell(2),ncell_loc(1),ncell_loc(2),ibuf,jbuf,2,2,flnm,dsetname,0)
 dsetname='ene'
 call output2d(q_loc(:,:,8),ncell(1),ncell(2),ncell_loc(1),ncell_loc(2),ibuf,jbuf,2,2,flnm,dsetname,0)
 dsetname='bxr'
 call output2d(q_loc(:,:,9),ncell(1),ncell(2),ncell_loc(1),ncell_loc(2),ibuf,jbuf,2,2,flnm,dsetname,0)
 dsetname='byr'
 call output2d(q_loc(:,:,10),ncell(1),ncell(2),ncell_loc(1),ncell_loc(2),ibuf,jbuf,2,2,flnm,dsetname,0)
 dsetname='bzr'
 call output2d(q_loc(:,:,11),ncell(1),ncell(2),ncell_loc(1),ncell_loc(2),ibuf,jbuf,2,2,flnm,dsetname,0)
