...
EXE    	= test.exe FindOne.exe Density.exe Kendall.exe Corotation.exe StellarGas.exe GasDensity.exe Ecg.exe Follow.exe Shift.exe
NOUSED  = 2Density.exe Rot.exe RelativeForce.exe
